...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      {path:'/product-ui', state: 'basicProductUiMenuOpen'},
    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/product-ui') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.basicProductUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicProductUiMenuOpen') } data-toggle="collapse">
              <span className="menu-icon">
                <i className="mdi mdi-laptop"></i>
              </span>
            ...
            <Collapse in={ this.state.basicProductUiMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={ this.isPathActive('/product-ui/product-list') ? 'nav-link active' : 'nav-link' } to="/product-ui/product-list"><Trans>Product List</Trans></Link></li>
                  <li className="nav-item"> <Link className={ this.isPathActive('/product-ui/product-add') ? 'nav-link active' : 'nav-link' } to="/product-ui/product-add"><Trans>Product Add</Trans></Link></li>
          ...
          <li className={ this.isPathActive('/error-pages') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            ...
            <Collapse in={ this.state.errorPagesMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={ this.isPathActive('/error-pages/error-402') ? 'nav-link active' : 'nav-link' } to="/error-pages/error-402">402</Link></li>
